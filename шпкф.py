...
armspec = pygame.image.load("ar1.png")
armspec = pygame.transform.scale(armspec, (600, 400))
pixcam = pygame.image.load("ud1.png")
pixcam = pygame.transform.scale(pixcam, (600, 400))
kill = pygame.image.load("image6.png")
kill = pygame.transform.scale(kill, (600, 400))
kolony = pygame.image.load("col1.png")
kolony = pygame.transform.scale(kolony, (600, 400))
